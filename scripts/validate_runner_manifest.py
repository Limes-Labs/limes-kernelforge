...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate a Limes KernelForge fixed-runner manifest.")
    parser.add_argument("--input", required=True, help="Fixed-runner manifest JSON.")
    parser.add_argument(
        "--contract",
